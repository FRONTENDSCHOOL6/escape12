        ...
        <div className='flex flex-col gap-10 items-center text-center py-32 s:py-20'>
          <div className='flex flex-col gap-3'>
            ...
            <fieldset className='flex flex-wrap gap-5 justify-between text-ec1 relative px-2'>
              <label className="w-32 s:min-w-fit">날짜
              </label>
              <input
                type="date"
                value={date}
            ...
            <fieldset className='flex flex-wrap gap-5 justify-between text-ec1 relative px-2'>
              <label className="w-32 s:min-w-fit">평점<sup className="text-red"> *</sup></label>
              <input
                type="number"
                min="1"
                max="10"
            ...
            <fieldset className='flex flex-wrap gap-5 justify-between text-ec1 relative px-2'>
              <label className='w-32 s:min-w-fit'>사진<sup className="text-red"> *</sup></label>
              <input
                type="file"
                className='w-[200px] s:w-[90%] text-ec4'
              />
