...
function RecordPage() {
	...
	return (
		<>
			...
			<div className="max-w-[600px] min-w-[320px] bg-ec4 text-ec1 flex flex-col items-center min-h-[100vh] m-auto text-lg pt-16 bg-light-ec1 dark:bg-dark-ec1 text-light-ec4 dark:text-dark-ec4">
				<Headerback
					onClick={() => {
						navigate(-1);
					}}
