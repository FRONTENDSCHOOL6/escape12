...
function Nav() {
  const isPostPageActive = useMatch('/Home');
      ...
      <ul className='flex justify-around items-center py-5'>
        <li>
          <NavLink
            ...
            className={`text-ec1 hover:text-ec5 ${isPostPageActive ? 'text-ec5' : ''}`}
          >
            테마
          </NavLink>
        </li>
        <li>
          <NavLink
            to='/notepage'
            activeClassName='text-ec5'
            className={`text-ec1 hover:text-ec5 ${isNotePageActive ? 'text-ec5' : ''}`}
          >
            기록
          </NavLink>
        </li>
        <li>
          <NavLink
            to='/addcommunity'
            activeClassName='text-ec5'
            className={`text-ec1 hover:text-ec5 ${isAddCommunityActive ? 'text-ec5' : ''}`}
          >
            커뮤니티
          </NavLink>
        </li>
        <li>
          <NavLink
            to='/mypage'
            activeClassName='text-ec5'
            className={`text-ec1 hover:text-ec5 ${isMyPageActive ? 'text-ec5' : ''}`}
          >
            마이
          </NavLink>
        </li>
