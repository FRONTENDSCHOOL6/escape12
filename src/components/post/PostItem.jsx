...
function PostItem({ id, title, author, content, src, alt }) {
	...
	return (
		<Link to={`/postpage/${id}`}>
			<div className="text-ec1 border-2 max-h-[105px] p-4 mb-6 rounded-xl flex flex-col m-auto  shadow-xl dark:shadow-darkMode transition-transform duration-500 ease-in-out transform hover:scale-105">
